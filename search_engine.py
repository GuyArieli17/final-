...
def run_engine(corpus_path, output_path, stemming, queries, num_docs_to_retrieve):
    ...
    for i in r.filesPath:
        print('Read package number: '  + str(i))
...
def search_and_rank_query(query, inverted_index,num_docs_to_retrieve):
    ...
    ranked_docs = searcher.ranker.rank_relevant_doc(relevant_docs,dictFromQuery,posting,map_reduce_ag,map_reduce_hq,map_reduce_rz,map_reduce_other,num_docs_to_retrieve)
